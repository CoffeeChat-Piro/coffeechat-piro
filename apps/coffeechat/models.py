...
class CoffeeChat(models.Model):
    ...
    profile = models.ForeignKey(Profile, related_name='requests', on_delete=models.CASCADE) # 커피챗 프로필 정보
...
class Review(models.Model):
    ...
    user = models.ForeignKey(User, related_name='coffeechat_reviews', on_delete=models.CASCADE)  # 리뷰를 작성한 사용자
